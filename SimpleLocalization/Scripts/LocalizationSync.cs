...
namespace Assets.SimpleLocalization.Scripts
{
	...
	public class LocalizationSync : MonoBehaviour
	{
		...
		public void Sync()
		{
			if (EditorUtility.DisplayDialog("Message", "LocalizationSync is obsolete, please use Window/SimpleLocalization or LocalizationSettings (Scriptable Object).", "Continue", "Abort"))
            {
                StopAllCoroutines();
